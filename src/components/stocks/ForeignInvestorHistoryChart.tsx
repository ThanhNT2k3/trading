...
interface ForeignInvestorHistoryChartProps {
  symbol?: string;
}

export default function ForeignInvestorHistoryChart({
  symbol = "VNINDEX",
}: ForeignInvestorHistoryChartProps) {
  ...
  if (loading) {
    return (
      <ComponentCard title="🌍 Foreign Investor Trading History (Khối Ngoại)">
